# 04. GEMINI.md 작성 완벽 가이드 — 4차 할루시네이션 검증 보고서 (R4)
...
|------|---------|------------|------|
| GEMINI.md 파일명 | GEMINI.md만 언급 | Antigravity CLI는 GEMINI.md와 AGENTS.md 모두 읽음. 리네임 불필요 | https://antigravity.google/docs/gcli-migration |
